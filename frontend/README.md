...
> Fork of [netflix-clone-using-react](https://github.com/sidmulajkar/netflix-clone-using-react) by sidmulajkar (103 stars) — integrated with PopCorn Mini's open-source ecosystem: Supabase Realtime chat, TMDB movie browsing, TG-FileStreamBot streaming, Telegram Mini App support, and Arabic/English i18n.

Original project credit below:
